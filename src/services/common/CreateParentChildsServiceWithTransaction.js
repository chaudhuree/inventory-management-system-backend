...
const CreateParentChildsServiceWithTransaction = async (Request, ParentModel, ChildsModel, JoinPropertyName) => {
...
module.exports = CreateParentChildsServiceWithTransaction